...
[Extract the release archive](#extract_the_release_archive) [Update the PATH environment variable](#update_the_path_environment_variable) [Edit the shell configuration file](#edit_the_shell_configuration_file) [Source the configuration file to see changes](#source_the_configuration_file_to_see_changes) [Verify installation](#verify_the_installation)
